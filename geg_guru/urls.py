...
urlpatterns = [
    ...
    path("api/download-report-pdf/", guru_views.download_report_pdf, name="download_report_pdf"),
    path("api/download-table-docx/", guru_views.download_table_docx, name="download_table_docx"),
    path("api/download-table-pdf/", guru_views.download_table_pdf, name="download_table_pdf"),
